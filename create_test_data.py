...
filename = [
    "./test_data/basic_information.csv",
    "./test_data/health_observation.csv",
    "./test_data/behavior_record.csv",
    "./test_data/infection_status.csv",        "./test_data/vaccine.csv"
]
...
def create_test_data():
    ...
    for fn in filename:
        ...
        for ind, rowdata in df.iterrows():
            ...
            if fn == "./test_data/basic_information.csv":
                # basic_informationテーブルの場合
                query_stacks += [f"""
                    INSERT INTO covid19.basic_information
                    ...
                    ;
                """]
            elif fn == "./test_data/health_observation.csv":
                # health_observationテーブルの場合
                query_stacks += [f"""
                    INSERT INTO covid19.health_observation
                    ...
                    ;
                """]
            elif fn == "./test_data/behavior_record.csv":
                # behavior_record.csvテーブルの場合
                query_stacks += [f"""
                    INSERT INTO covid19.behavior_record
                    ...
                    ;
                """]
            elif fn == "./test_data/infection_status.csv":
                # infection_statusテーブルの場合
                query_stacks += [f"""
                    INSERT INTO covid19.infection_status
